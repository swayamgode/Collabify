...
export async function updateInfluencerDetails(formData: FormData): Promise<{ success: boolean; error?: string }> {
    try {
        revalidatePath('/settings')
        return { success: true }
    } catch (error: any) {
        return { success: false, error: error.message || 'Failed to update influencer details' }
    }
}

export async function updateBrandDetails(formData: FormData): Promise<{ success: boolean; error?: string }> {
    try {
        revalidatePath('/settings')
        return { success: true }
    } catch (error: any) {
        return { success: false, error: error.message || 'Failed to update brand details' }
    }
}
